...
class StyleControllerCest
{
    protected const URL = 'api/styles/';
    ...
    public function getStyleTest()
    {
        $this->apiTester->wantTo('get Style By id');
    ...
    public function getStylesListTest()
    {
        $this->apiTester->wantTo('get Style List');
        $this->apiTester->haveHttpHeader('Content-Type', 'application/json');
        $this->apiTester->sendGet(self::URL);
        $this->apiTester->seeResponseCodeIs(200);
    }

    public function createStyleTest()
    {
        $this->apiTester->wantTo('create a Style');
        $this->apiTester->haveHttpHeader('Content-Type', 'application/json');
    ...
    public function updateStyleTest()
    {
        $this->apiTester->wantTo('update Style');
        $this->apiTester->haveHttpHeader('Content-Type', 'application/json');
    ...
    public function deleteStyleTest()
    {
        $this->apiTester->wantTo('delete a Style');
        $this->apiTester->haveHttpHeader('Content-Type', 'application/json');
