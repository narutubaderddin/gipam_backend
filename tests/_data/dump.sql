...
CREATE TABLE type_constat_action (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, libelle VARCHAR(255) NOT NULL);
...
CREATE TABLE type_localisation (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, libelle VARCHAR(255) DEFAULT NULL);
...
CREATE TABLE type_mouvement_action (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, type_mouvement_id INTEGER DEFAULT NULL, libelle VARCHAR(255) NOT NULL);
CREATE TABLE type_mouvement (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, libelle VARCHAR(150) DEFAULT NULL);
...
CREATE TABLE sous_type_constat (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, type_constat_id INTEGER DEFAULT NULL, libelle VARCHAR(255) DEFAULT NULL);
CREATE TABLE type_constat (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, libelle VARCHAR(255) NOT NULL);
