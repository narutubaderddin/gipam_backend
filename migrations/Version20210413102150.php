 ...
 */
final class Version20210413102150 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE auteur (id INT AUTO_INCREMENT NOT NULL, prenom VARCHAR(255) DEFAULT NULL, nom VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE correspondant (id INT AUTO_INCREMENT NOT NULL, etablissement_id INT DEFAULT NULL, sous_direction INT DEFAULT NULL, service INT DEFAULT NULL, prenom VARCHAR(255) NOT NULL, nom VARCHAR(255) NOT NULL, telephone VARCHAR(255) DEFAULT NULL, fax VARCHAR(255) DEFAULT NULL, mail VARCHAR(255) DEFAULT NULL, date_debut DATETIME DEFAULT NULL, date_fin DATETIME DEFAULT NULL, INDEX IDX_E4DD79A3FF631228 (etablissement_id), INDEX IDX_E4DD79A325433AFC (sous_direction), INDEX IDX_E4DD79A3E19D9AD2 (service), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE denomination (id INT AUTO_INCREMENT NOT NULL, domaine_id INT DEFAULT NULL, libelle VARCHAR(255) DEFAULT NULL, INDEX IDX_15AEA10C4272FC9F (domaine_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE domaine (id INT AUTO_INCREMENT NOT NULL, libelle VARCHAR(255) DEFAULT NULL, active TINYINT(1) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE epoque (id INT AUTO_INCREMENT NOT NULL, libelle VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE fichier_joint (id INT AUTO_INCREMENT NOT NULL, objet_mobilier_id INT DEFAULT NULL, date DATETIME NOT NULL, commentaire LONGTEXT DEFAULT NULL, lien VARCHAR(255) NOT NULL, image_principale TINYINT(1) NOT NULL, INDEX IDX_AAACC83FB7105527 (objet_mobilier_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE log_ouvre (id INT AUTO_INCREMENT NOT NULL, objet_mobilier_id INT DEFAULT NULL, date DATETIME DEFAULT NULL, INDEX IDX_D1723633B7105527 (objet_mobilier_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE matiere_technique (id INT AUTO_INCREMENT NOT NULL, libelle VARCHAR(255) DEFAULT NULL, type VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE mode_entree (id INT AUTO_INCREMENT NOT NULL, libelle VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE status (id INT AUTO_INCREMENT NOT NULL, type VARCHAR(255) DEFAULT NULL, date_debut DATETIME DEFAULT NULL, date_fin DATETIME DEFAULT NULL, commentaire LONGTEXT DEFAULT NULL, discr VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE style (id INT AUTO_INCREMENT NOT NULL, libelle VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE type_auteur (id INT AUTO_INCREMENT NOT NULL, auteur_id INT DEFAULT NULL, libelle VARCHAR(255) DEFAULT NULL, INDEX IDX_268DDA7860BB6FE6 (auteur_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE type_deposant (id INT AUTO_INCREMENT NOT NULL, libelle VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE type_mouvement (id INT AUTO_INCREMENT NOT NULL, libelle DATETIME DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE correspondant ADD CONSTRAINT FK_E4DD79A325433AFC FOREIGN KEY (sous_direction) REFERENCES sous_direction (id)');
        $this->addSql('ALTER TABLE correspondant ADD CONSTRAINT FK_E4DD79A3E19D9AD2 FOREIGN KEY (service) REFERENCES service (id)');
        ...
        $this->addSql('ALTER TABLE log_ouvre ADD CONSTRAINT FK_D1723633B7105527 FOREIGN KEY (objet_mobilier_id) REFERENCES objet_mobilier (id)');
        ...
        $this->addSql('ALTER TABLE objet_mobilier ADD CONSTRAINT FK_A38B3DB66BF700BD FOREIGN KEY (status_id) REFERENCES status (id)');
        ...
        $this->addSql('ALTER TABLE ouvre_art ADD CONSTRAINT FK_89F9647BBF396750 FOREIGN KEY (id) REFERENCES objet_mobilier (id) ON DELETE CASCADE');
        ...
        $this->addSql('ALTER TABLE statut_depot ADD CONSTRAINT FK_7569E4C2BF396750 FOREIGN KEY (id) REFERENCES status (id) ON DELETE CASCADE');
        ...
        $this->addSql('ALTER TABLE statut_propriete ADD CONSTRAINT FK_D206CE51BF396750 FOREIGN KEY (id) REFERENCES status (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE type_auteur ADD CONSTRAINT FK_268DDA7860BB6FE6 FOREIGN KEY (auteur_id) REFERENCES auteur (id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE type_auteur DROP FOREIGN KEY FK_268DDA7860BB6FE6');
        ...
        $this->addSql('ALTER TABLE log_ouvre DROP FOREIGN KEY FK_D1723633B7105527');
        ...
        $this->addSql('ALTER TABLE ouvre_art DROP FOREIGN KEY FK_89F9647BBF396750');
        ...
        $this->addSql('ALTER TABLE correspondant DROP FOREIGN KEY FK_E4DD79A3E19D9AD2');
        $this->addSql('ALTER TABLE batiment DROP FOREIGN KEY FK_F5FAB00CF6BD1646');
        $this->addSql('ALTER TABLE correspondant DROP FOREIGN KEY FK_E4DD79A325433AFC');
