            ...
            foreach ($arr as $key => $value) {
                if (is_array($value)) {
                    ...
                    if ($value == "null" || json_decode($value) == "null") {
                        ...
                        }  elseif (in_array($key, ['url','descriptiveWords', 'title', 'marking', 'registrationSignature','insuranceValue', 'otherRegistrations', 'description', 'name', 'inventoryNumber', 'imagePreview','link'])) {
                            $result[$key] = $value;
                        }else{
